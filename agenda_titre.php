...
<?php message($msg); ?>
    <TD align="right" nowrap class="PageDate"><B><?php echo $tabJour[date("w",$sd)]." ".$jourEnCours." ".strtolower($tabMois[date("n",$sd)])." ".$anneeEnCours; ?></B>&nbsp;&nbsp;<BR><A style="COLOR: <?php echo $PageDate; ?>;FONT-SIZE: 10px;"><?php echo sprintf(trad("TITRE_FETE_JOUR"),$feteDuJour); ?></A>&nbsp;&nbsp;</TD>
  </TR>
  </TABLE>
