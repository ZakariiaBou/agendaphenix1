<?php
  ...
  *  option) any later version.                                              *
  ...
  function afficheCalendrier($moisCrt,$anneeCrt) {
    ...
    global $decalageHoraire, $age_date, $age_dateAvant, $age_heure_debut, $age_heure_fin, $age_date_creation;
    ...
    $tsSemaine = mktime(12,0,0,$moisCrt, 1, $anneeCrt);
    ...
    $premierJour = date("w",mktime(12,0,0,$moisCrt, 1, $anneeCrt));
    if ($premierJour == 0)
      $premierJour = 7;
    ...
    prepareDecalageH($tzGmt,$tzEte,$tzHiver,$tsSemaine);
    ...
    $nbJourMois = date("t",mktime(12,0,0,$moisCrt, 1, $anneeCrt));
    ...
    for($j=1;!$finDeMois;$j++) {
      if (checkdate($moisCrt, $nbJour+1, $anneeCrt)) {
        $tsSemaine = mktime(12,0,0,$moisCrt, $nbJour+1, $anneeCrt);
