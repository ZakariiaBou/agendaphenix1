...
?>
    <TR bgcolor="<?php echo $bgColor[++$iColor%2]; ?>">
      ...
      <TD style="padding-bottom:2px;" class="tabInput"><?php echo trad("PROFIL_AUTORISE_CONSULT"); ?><BR>
        ...
        <TR>
          <TD><SELECT name="zlUtilisateur" id="zlUtilisateur" size="6" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;">
<?php
  $tabPartage = array();
...
?>
          ...
          <TD><SELECT name="zlPartage" id="zlPartage" size="6" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px; border:<?php echo $FormulaireBordureInput; ?>;"></SELECT></TD>
        </TR>
<?php
  if ($NoGroupe) {
?>
        ...
        <TR>
          <TD><SELECT name="zlGroupe" id="zlGroupe" size="3" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;">
<?php
  $tabPrtGroupe = array();
  // On recupere la liste des personnes concernees par le partage sauf l'utilisateur courant
  if ($ztAction=="UPDATE") { // On n'est pas dans le cas d'une creation de compte
...
?>
          ...
          <TD><SELECT name="zlPrtGroupe" id="zlPrtGroupe" size="3" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px; border:<?php echo $FormulaireBordureInput; ?>;"></SELECT></TD>
        </TR>
<?php
  } else {
...
?>
      ...
      <TD style="padding-bottom:1px;" class="tabInput"><?php echo trad("PROFIL_AUTORISE_AFFECT"); ?><BR><SELECT name="zlAffectation" size="1" tabindex="<?php echo $tabIndex++; ?>" onchange="selectAffect(this.value);">
        ...
        <TR>
          <TD><SELECT name="zlUtilisateur2" id="zlUtilisateur2" size="6" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;">
<?php
  $tabPartage = array();
...
?>
          ...
          <TD><SELECT name="zlAffecte" id="zlAffecte" size="6" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px; border:<?php echo $FormulaireBordureInput; ?>;"></SELECT></TD>
        </TR>
...
?>
        ...
        <TR>
          <TD><SELECT name="zlGroupe2" id="zlGroupe2" size="3" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;">
<?php
  $tabAffGroupe = array();
  // On recupere la liste des personnes concernees par le partage sauf l'utilisateur courant
  if ($ztAction=="UPDATE") { // On n'est pas dans le cas d'une creation de compte
...
?>
          ...
          <TD><SELECT name="zlAffGroupe" id="zlAffGroupe" size="3" multiple tabindex="<?php echo $tabIndex++; ?>" style="width:200px; border:<?php echo $FormulaireBordureInput; ?>;"></SELECT></TD>
        </TR>
<?php
  } else {
...
?>
    <TR bgcolor="<?php echo $bgColor[++$iColor%2]; ?>">
      ...
      <TD style="padding-bottom:2px;" class="tabInput"><TABLE cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
        ...
        <TR>
          <TD><SELECT size="6" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;" >
<?php
...
?>
          ...
          <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
          <TD align="right"><SELECT size="6" style="width:200px;border: <?php echo $FormulaireBordureInput; ?>;">
<?php
  ...
  <DIV id="divAdmin" style="display: none">
    ...
    <TR bgcolor="<?php echo $bgColor[++$iColor%2]; ?>" height="21">
      ...
      <TD class="tabInput"><SELECT name="zlAMProfils" size="1" style="width: 350px;" tabindex="<?php echo $tabIndex++; ?>">
        ...
        <OPTION value="<?php echo _DROIT_PROFIL_COMPLET; ?>"<?php if ($dr_PROFILS==_DROIT_PROFIL_COMPLET) echo " selected"; ?>><?php echo trad('PROFIL_ADMIN_PROFILS_6'); ?></OPTION>
      </SELECT></TD>
    </TR>
    <TR bgcolor="<?php echo $bgColor[++$iColor%2]; ?>" height="21">
