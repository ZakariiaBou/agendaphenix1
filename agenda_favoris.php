...
<?php } ?>
  ...
  <BR>
  <FORM action="agenda_traitement.php?sid=<?php echo $sid; ?>&tcMenu=<?php echo $tcMenu; ?>&tcPlg=<?php echo $tcPlg; ?>&sd=<?php echo gmdate("Y-n-j", $sd); ?>" method="post" name="FormFavoris">
