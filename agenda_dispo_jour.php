...
<?php
  ...
  if (!empty($sChoix)) {
    ...
    // Recuperation de l'heure de debut de journee minimale et de l'heure de fin de journee maximale
    // Pour permettre de visualiser les creneaux horaire sur la plus grande plage commune
    //$iHeureMin = 24;
    //$iHeureMax = 0;
...
<?php
    ...
    while (list($sUtilID,$sNomUtil)=each($aUtilPartage)) {
      ...
      $sql .= "       age_lieu, CONCAT(".$FORMAT_NOM_CONTACT.") AS nomContact, $age_date AS dateNote";
